 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.0.7/af-2.7.0/b-3.0.2/b-colvis-3.0.2/b-html5-3.0.2/b-print-3.0.2/cr-2.0.2/date-1.5.2/fc-5.0.0/fh-4.0.1/kt-2.12.0/r-3.0.2
 *
 * Included libraries:
 *   jQuery 3 3.7.0, DataTables 2.0.7, AutoFill 2.7.0, Buttons 3.0.2, Column visibility 3.0.2, HTML5 export 3.0.2, Print view 3.0.2, ColReorder 2.0.2, DateTime 1.5.2, FixedColumns 5.0.0, FixedHeader 4.0.1, KeyTable 2.12.0, Responsive 3.0.2
 */
